 ...
 * @author Vinícius
 */
public class AutorCreate extends javax.swing.JFrame {

    /**
     * Creates new form AutorCreate
     */
    public AutorCreate() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AutorCreate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AutorCreate().setVisible(true);
            }
        });
    }
